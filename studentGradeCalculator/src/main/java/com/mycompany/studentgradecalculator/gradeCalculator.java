...
int totalMarks=0;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 257, 73, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("IT");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 307, 54, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setText("Science");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 383, 54, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setText("Tamil");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 474, 54, -1));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setText("English");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 423, 54, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel8.setText("Maths");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 345, 54, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel9.setText("Marks");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(214, 257, 61, -1));

        txtIt.setBackground(new java.awt.Color(204, 204, 204));
        txtIt.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jPanel1.add(txtIt, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 304, 109, -1));

        txtMath.setBackground(new java.awt.Color(204, 204, 204));
        txtMath.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jPanel1.add(txtMath, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 342, 109, -1));

        txtSci.setBackground(new java.awt.Color(204, 204, 204));
        txtSci.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jPanel1.add(txtSci, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 380, 109, -1));

        txtEng.setBackground(new java.awt.Color(204, 204, 204));
        txtEng.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jPanel1.add(txtEng, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 420, 109, -1));

        txtTam.setBackground(new java.awt.Color(204, 204, 204));
        txtTam.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jPanel1.add(txtTam, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 471, 109, -1));

        btnCal.setBackground(new java.awt.Color(204, 204, 204));
        btnCal.setFont(new java.awt.Font("Segoe UI", 1, 32)); // NOI18N
        ...
        jPanel1.add(btnCal, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 320, -1, -1));
        ...
        jPanel1.add(btnAnalysis, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 535, -1, -1));
        ...
        jPanel1.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 220, 110, -1));

        btnClear.setBackground(new java.awt.Color(204, 204, 204));
        btnClear.setFont(new java.awt.Font("Segoe UI", 1, 32)); // NOI18N
        ...
        jPanel1.add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(366, 415, 170, -1));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 50)); // NOI18N
        jLabel1.setText("Student Grade Calculator");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 120, 629, -1));
