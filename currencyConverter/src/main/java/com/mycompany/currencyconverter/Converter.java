 ...
 public void convertCurrency(double amount, String from, String to) {
  ...
  private double getExchangeRate(String from, String to) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(cmbFrom, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 340, 130, 30));
        ...
        jPanel1.add(cmbTo, new org.netbeans.lib.awtextra.AbsoluteConstraints(197, 340, 130, 30));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel6.setText("To");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 320, 37, -1));
        ...
        jPanel1.add(btnConvert, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 410, 80, 40));
        ...
        jPanel1.add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 410, 90, 40));

        btnQuitBut.setBackground(new java.awt.Color(153, 153, 255));
        btnQuitBut.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnQuitBut.setText("Quit");
        btnQuitBut.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102), 4));
        ...
        jPanel1.add(btnQuitBut, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 410, 90, 40));
    ...
    private void btnClearMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnClearMouseEntered
         defaultBackgroundColor = btnClear.getBackground();  
    ...
    private void btnQuitButMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnQuitButMouseEntered
          defaultBackgroundColor =  btnQuitBut.getBackground();  
     btnQuitBut.setBackground(Color.GREEN);
    ...
    private void btnQuitButMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnQuitButMouseExited
      btnQuitBut.setBackground(defaultBackgroundColor); 
    ...
    private void btnQuitButActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuitButActionPerformed
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            for (Window window : Window.getWindows()) {
                if (window instanceof Converter) {
                    ((Converter) window).dispose();
                }
            }
        }
